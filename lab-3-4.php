...
<FORM method="post" action="<?php print $PHP_SELF ?>">
 Введите логин:
	...
	<INPUT type="hidden" name="h" value="kol_val">
	<INPUT type="hidden" name="b" value="ivan_iv">
    <INPUT type="hidden" name="n" value="no_name_1">
	<INPUT type="hidden" name="m" value="stud_ugatu">
  <P> <INPUT type="submit" name="obr" value="Продолжить">
</FORM>
<?
if (isset($_POST["obr"])) {
if ($_POST["a"]==$_POST["h"]) { echo ("Здравствуйте, Колесова Валерия Юрьевна!");
 } else {
